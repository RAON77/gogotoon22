<?
    ...
    if (!isStrpos("google,facebook,apple", $sns_gubun)) fnMsgGo(500, getTransLangMsg("잘못된 요청 정보 입니다."), "/member/login.php", "");
    if (isUser()) fnMsgGo(5001, "", "/", "");
?>
<!DOCTYPE html>
<html lang="ko">
<head>
            ...
            if (user) {
                ...
                if (user != null) {
                    ...
                    if (providerId.indexOf(sns_gubun) > -1) {
                        AJ.callAjax("/member/sns/login_proc.php", {"sns_gubun": sns_gubun, "email": email, "uid": uid}, function(data){
                            if (data.result == 200) {
                ...
                <section class="popup">
                    ...
                    <div class="p_cont">
                        ...
                        <div class="hd_titbox1">
                            <h2 class="title1 ta-c"><?=getTransLangMsg("로그인 처리중 입니다. 잠시만 기다려주세요.")?></h2>
                        </div>
