<?
    ...
    $params['sns']         = chkReqRpl("sns", "", 20, "POST", "STR");

    if (chkBlank($params['sns']) || !isStrpos("facebook,twitter", $params['sns'])) fnMsgJson(502, getTransLangMsg("요청정보 값이 유효하지 않습니다."), "");
    ...
    if ($cls_wt->sns_share_save($params, $point_save) == false) fnMsgJson(504, getTransLangMsg("저장 처리중 문제가 발생했습니다.\n고객센터에 문의주세요."), "");
?>
